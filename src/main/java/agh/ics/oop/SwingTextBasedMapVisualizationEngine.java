...
public class SwingTextBasedMapVisualizationEngine implements IMapVisualizationEngine {
    ...
    SwingTextBasedMapVisualizationEngine(IWorldMap map, Vector2d lowerLeft, Vector2d upperRight) {
        this.map = map;
